...
* Preconditions: Ninguna
* Overview: inversi�n del reloj del DAC, Forces PDAC_CLK to be 1
* Input: 0 =  Apagado Y 1 = Encendido
* Output: Ninguna
* Nota:  SENS_SAR_DAC1
*****************************************************************************/
...
* Preconditions: Ninguna
* Overview: inversi�n del reloj del DAC, Forces PDAC_CLK to be 0
* Input: 0 =  Apagado Y 1 = Encendido
* Output: Ninguna
* Nota:  SENS_SAR_DAC1
*****************************************************************************/
...
* Overview: Enciende el m�dulo DAC
* Input: Canal (0 o 1)
* Output: Ninguna
*
*****************************************************************************/
